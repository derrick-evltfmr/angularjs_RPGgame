...
export const Chapter3: Chapter = {
	...
	rewards: {
		...
		newHero: [new Warrior("Jessica", GenderOptions.female, CampOptions.strengthCountry, 6, 52, {attack: 35, sneak: 14,
				persuade: 12, intelligence: 8}, new Weapon("Power Sword", 6, 12), new Armor("Warrior Armor", 9)),
				new Ranger("Iris", GenderOptions.female, CampOptions.dexterityCountry, 6, 42, {attack: 20, sneak: 36,
